    ...
    var RemoveContent = React.createClass({displayName: "RemoveContent",
     ...
     var layout = {
           ...
           var source = {
            ...
            $.ajax({
                ...
                success: function(response) {
                    var isDeleted = response.indexOf("true") < 0?false:tru;
                    if (isDeleted){
                        var newLayout = [];
                        $.each(layout.layoutData, function(i, val) {
        ...
        saveLayout: function(layoutName, isDefault, existsLayout) {
            var source = layout.queryLayoutForSave();
            source.module = layout.module;
            $.ajax({
                type: "post",
                ...
                success: function(response) {
                    ...
                    existsLayout || layout.layoutData.push(layout.currentLayoutData);
