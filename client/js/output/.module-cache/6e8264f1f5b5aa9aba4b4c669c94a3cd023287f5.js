...
;(function($, undefined) {
    ...
    var LayoutBase = React.createClass({displayName: "LayoutBase",
        ...
        componentDidMount: function() {
            ...
            $dom.on("click", function(event) {
                ...
                if ($dom.hasClass('open')) {
                   that.setState({list:layout.source});
                }
            });
        ...
        render:function() {
            var that =this;
            return  React.createElement("button", {onClick: this.addLayout}, "asg");
            // return   <div  className="filter_item columnLayout" style={{position: "relative",float: "right", height:30,display: "inline-block"}}>
            //     <div style={{cursor: "pointer"}}>
            //         <span id="columnLayoutBtn" className="layoutsetting"></span>
            //     </div>
            ...
            //                 return <li><a>
            //                     <span data-check className="check" style={{visibility:layout.currentLayoutData.LayoutName == item.LayoutName ? "visible" : "hidden"}}>
            //                     </span>
            ...
            //                     <span className={item.className}></span>{item.text}
            //                 </a></li>;
            //             })
            //         }
            //     </ul>;
    ...
    var RemoveContent = React.createClass({displayName: "RemoveContent",
     ...
     var layout = {
        ...
        actions:[{action:'addOrRemoveColumn',className:'iconcolumn',text:'Add\Remove Columns'},{action:'save',className:'iconsave',text:'Save Layout'},{action:function(){alert(2)},className:'icondelete',text:'Delete Layout'},{action:'delete',className:'icondelete',text:'Delete Layout'},{action:'reset',className:'iconreset',text:'Reset Layout'}],
        currentLayoutData:{},
