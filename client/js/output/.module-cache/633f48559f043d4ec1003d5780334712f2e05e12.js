            ...
            $.fn[name] = function(options) {
                ...
                if (typeof options === "string") {
                    ...
                    this.each(function() {
                        ...
                        if (!widget) {
                            throw new Error("Cannot call method '{0}' of {1} before it is initialized".format(options, name2))
                        }
...
;(function($, undefined) {
    ...
    var AddPopContent = React.createClass({displayName: "AddPopContent",
        ...
        addLayout: function() {
            ...
            if (layoutName == "") {AddContentAddPopContent
            ...
            Event.fire('saving',layoutName, isDefaultAddPopContentt);
        ...
        initEvent: function(dom,actions) {
            ...
            Event.add("selected", function(item) {
                ...
                React.render(
                    ...
                    dAddPopContentementById('addLaypoutPop' + '_content')
                );
                ...
                React.render(
                    ...
                    dRemovePopContentntById('removeLayoutPop' + '_content')
                );
