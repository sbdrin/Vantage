...
;(function($, undefined) {
    ...
    var LayoutBase = React.createClass({displayName: "LayoutBase",
        ...
        render: function() {
            var that = this;
            return React.createElement("div", {className: " columnLayout", style: {position: "relative",float: "right", height:30,display: "inline-block"}}, 
                React.createElement("div", {style: {cursor: "pointer"}}, 
                    React.createElement("span", {className: "layoutsetting"})
                ), 
    ...
    var layout = {
        ...
        initEvent: function(actions, source) {
            ...
            Event.add("addOrRemoveColumn", function() {
                ...
                React.render(
                    React.createElement(RemoveContent, {list: source}),
        ...
        init: function() {
            ...
            layout.initDom(this);
            layout.initEvent(layout.actions, layout.source);
        },
