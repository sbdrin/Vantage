...
(function(undefined) {
    ...
    var LayoutBase = React.createClass({displayName: "LayoutBase",
        ...
        componentDidMount: function() {
            ...
            $dom.on("click", function(event) {
                ...
                if ($dom.hasClass('open')) {
                   that.setState(variables.layoutData);
                }
            });
        ...
        render:function() {
            return   React.createElement("div", {className: "filter_item columnLayout", style: {position: "relative",float: "right", display: "inlineBlock"}}, 
                ...
                React.createElement("ul", {className: "dropdown-menu pull-left"}, 
                        ...
                        this.state.list.map(function(item){
                            return React.createElement("li", null, React.createElement("a", null, 
                                React.createElement("span", {"data-check": true, className: "check", style: {visibility:variables.currentLayoutData.LayoutName == item.LayoutName ? "visible" : "hidden"}}
                                ), 
    ...
    var RemovePop = React.createClass({displayName: "RemovePop",
        componentDidMount: function() {
    ...
    var layout = {
        initEvent:function(){
            Event.add("addOrRemoveColumn",function(){
                ...
                React.render(
                    React.createElement(RemovePop, {list: variables.layoutData}),
                    document.getElementById('tbl_layoutList')
                );
                ...
                $deletePop.jqxWindow({height:80 + variables.layoutData.length * 21}).jqxWindow('open');
        ...
        initLayout: function() {
            ...
            React.render(
                    ...
                    document.getElementById('columnLayout')
            );
