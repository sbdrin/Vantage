...
;(function($, undefined) {
    var Event = {
        ...
        fire: function(action) {
            Event[action] && Event[action].fire(Array.prototype.slice.call(arguments,1));
        }
    };
        ...
        render: function() {
            ...
            return React.createElement("div", {style: {position: "relative"}}, 
                React.createElement("div", {style: {cursor: "pointer"}}, 
                    React.createElement("span", {className: "layout_icon"})
                ), 
                React.createElement("ul", {className: "dropdown-menu pull-left"}, 
                        ...
                        that.state.list.map(function(item){
                            return React.createElement("li", null, React.createElement("a", null, 
                                React.createElement("span", {"data-check": true, className: "check", style: {visibility:that.state.currentLayout.LayoutName == item.LayoutName ? "visible" : "hidden"}}
                                ), 
    ...
    var layout = {
        ...
        initEvent: function(dom,actions) {
            ...
            Event.add("selected", function(item) {
                layout.onSelected && layout.onSelected(item);
